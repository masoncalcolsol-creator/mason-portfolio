    ...
    const render = (time: number) => {
      ...
      if (dropElapsed >= 0) {
        drops.forEach((drop) => {
          ...
          drawDrop(width * drop.xRatio, y, drop.radius);
        });
      }
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 640px) {
          ...
          .sequence-nav > a { max-width: 145px; line-height: 1.35; }
          .sequence-nav > div { flex-direction: column; align-items: flex-end; gap: 6px; }
          .sequence-nav b { max-width: 132px; }
          .settled-content { padding-left: 12px; padding-right: 12px; }
