...
export default function JasonAnvilPromptSafeClient() {
  ...
  const packet = useMemo(() => {
    ...
    const exclude =
      "artist names, band names used as references, vocalist names, guitarist names, clone language, in-the-style-of language, sounds-like language, EDM drops, trap switch, DJ scratches, pop-punk gloss, glossy arena-rock polish, extended cinematic intro, unrelated genre montage, comedy novelty mix, recognizable copyrighted melody, borrowed lyric, copied riff, overlong solo, fade-out ending";
