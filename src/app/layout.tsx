...
export const metadata: Metadata = {
  ...
  description:
    "Founder of NULLWORKS. I design human-readable Operational Intelligence systems that coordinate experts, AI workers, workflows, evidence, authority, continuity, and telemetry.",
  openGraph: {
