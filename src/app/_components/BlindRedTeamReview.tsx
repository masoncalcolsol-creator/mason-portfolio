...
export default function BlindRedTeamReview({reviewerName,firstName,artifactName,artifactVersion,artifactUrl,responseEmail,responseSubject}:BlindRedTeamReviewProps){
  ...
  return <main className={styles.page}><div className={styles.shell}>
    ...
    <section className={styles.compactHero}><div className={styles.eyebrow}>Cold review</div><h1 className={styles.title}>{firstName}, try to break this.</h1><p className={styles.lead}>Your target is <strong>{artifactName}</strong> ({artifactVersion}). Read this copy before looking up NULLWORKS, Continuity Calculus, or any supporting material.</p><div className={styles.actions}><a className={styles.primary} href={downloadUrl}>Download paper</a><a className={styles.secondary} href={mailto}>Send first-pass review</a></div></section>
    ...
    <section className={styles.section}><div className={styles.sectionHeader}><div className={styles.kicker}>Locked review artifact</div><h2 className={styles.h2}>{artifactName}</h2><p className={styles.body}>Download the locked review PDF below and open it in your preferred PDF reader.</p></div><div className={styles.statement}><strong>Exact review copy</strong><p>This link resolves to the locked artifact used for this review.</p><div className={styles.actions}><a className={styles.primary} href={downloadUrl}>Download PDF</a></div></div><figure style={{margin:"28px 0 0"}}><img src="/continuity-calculus/infographic" width="1075" height="1519" alt="NULLWORKS Continuity Calculus architecture infographic" style={{display:"block",width:"100%",height:"auto",borderRadius:18,border:"1px solid #293638"}}/><figcaption style={{marginTop:10,opacity:.72,fontSize:13}}>Continuity Calculus · architecture overview</figcaption></figure></section>
