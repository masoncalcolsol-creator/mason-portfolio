      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .records-page {
          ...
          overflow-x: hidden;
          background:
            radial-gradient(circle at 82% 4%, rgba(214,177,93,.12), transparent 29rem),
            radial-gradient(circle at 8% 36%, rgba(186,255,53,.08), transparent 30rem),
            #090909;
          font-family: Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
        }
        .shell { width: min(1200px, calc(100% - 38px)); margin: 0 auto; }
        .nav { position: sticky; top: 0; z-index: 70; border-bottom: 1px solid rgba(255,255,255,.11); background: rgba(9,9,9,.84); backdrop-filter: blur(18px); }
        ...
        .nav-links a { color: #c8c6bc; text-decoration: none; border: 1px solid rgba(255,255,255,.14); border-radius: 999px; padding: 8px 11px; font-size: 12px; font-weight: 800; }
        .nav-links a:hover { color: #090909; background: var(--acid); border-color: var(--acid); }
        .hero { min-height: 95svh; display: grid; align-items: center; position: relative; overflow: hidden; border-bottom: 1px solid rgba(255,255,255,.11); }
        .hero::before { content: "ANVIL"; position: absolute; left: -8vw; top: 7%; color: rgba(255,255,255,.028); font-size: clamp(160px, 35vw, 500px); font-weight: 950; line-height: .7; letter-spacing: -.11em; transform: rotate(-5deg); }
        .hero::after { content: "RECORDS"; position: absolute; right: -17vw; bottom: 2%; color: rgba(186,255,53,.035); font-size: clamp(130px, 29vw, 420px); font-weight: 950; line-height: .7; letter-spacing: -.1em; transform: rotate(5deg); }
        ...
        h1 span { display: block; color: transparent; -webkit-text-stroke: 1px rgba(244,243,237,.56); }
        .lead { max-width: 850px; margin-top: 30px; color: #c7c5bb; font-size: clamp(20px, 2.3vw, 27px); line-height: 1.52; }
        .hero-card { border: 1px solid rgba(186,255,53,.32); border-radius: 30px; padding: 27px; background: linear-gradient(145deg, rgba(186,255,53,.09), rgba(255,255,255,.025)); }
        ...
        .hero-card p { color: #b6b5ac; line-height: 1.67; }
        .cta-row { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 25px; }
        .cta { display: inline-flex; align-items: center; justify-content: center; padding: 13px 17px; border-radius: 999px; background: var(--acid); color: #090909; font-weight: 950; text-decoration: none; }
        .cta.secondary { color: var(--acid); background: transparent; border: 1px solid rgba(186,255,53,.4); }
        .manifesto { padding: 92px 0; border-bottom: 1px solid rgba(255,255,255,.11); }
        ...
        .manifesto p { max-width: 900px; color: #b6b4ac; font-size: 19px; line-height: 1.72; }
        .section { padding: 84px 0; border-bottom: 1px solid rgba(255,255,255,.11); }
        ...
        .release { position: relative; display: grid; grid-template-columns: 90px 1fr auto; gap: 22px; align-items: center; min-height: 190px; border: 1px solid rgba(255,255,255,.14); border-radius: 26px; padding: 23px; background: linear-gradient(145deg, rgba(255,255,255,.04), rgba(255,255,255,.015)); overflow: hidden; }
        .release::after { content: attr(data-order); position: absolute; right: 20%; top: -34px; color: rgba(255,255,255,.028); font: 950 180px/.8 ui-monospace, monospace; }
        .order { position: relative; z-index: 2; color: var(--acid); font: 950 48px/.8 ui-monospace, monospace; }
        ...
        .release p { max-width: 760px; color: #aaa99f; line-height: 1.6; }
        .release a { position: relative; z-index: 2; white-space: nowrap; border-radius: 999px; padding: 12px 15px; background: var(--acid); color: #090909; text-decoration: none; font-weight: 950; }
        .explicit-mark { display: inline-block; margin-left: 8px; color: #dcb0ff; font: 900 10px ui-monospace, monospace; letter-spacing: .12em; }
        .development-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 13px; }
        .dev-card { min-height: 230px; border: 1px solid rgba(255,255,255,.13); border-radius: 24px; padding: 22px; background: rgba(255,255,255,.022); }
        ...
        .dev-card p { color: #a9a79f; line-height: 1.62; }
        .cap-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; }
        .cap { min-height: 170px; display: flex; flex-direction: column; justify-content: space-between; border: 1px solid rgba(255,255,255,.13); border-radius: 22px; padding: 19px; background: rgba(255,255,255,.022); }
        .cap b { color: var(--acid); font: 900 11px ui-monospace, monospace; letter-spacing: .14em; }
        .cap span { color: #c5c3bb; font-weight: 800; line-height: 1.4; }
        .boundary { border: 1px solid rgba(214,177,93,.35); border-radius: 30px; padding: clamp(25px, 4vw, 42px); background: linear-gradient(145deg, rgba(214,177,93,.09), rgba(255,255,255,.02)); }
        .boundary strong { display: block; max-width: 920px; font-size: clamp(38px, 6vw, 75px); line-height: .94; letter-spacing: -.055em; }
        .boundary p { max-width: 930px; color: #bbb9b0; font-size: 18px; line-height: 1.7; }
        .boundary small { display: block; margin-top: 20px; color: #85847d; line-height: 1.65; }
        footer { padding: 44px 0 75px; color: #7d7c75; }
