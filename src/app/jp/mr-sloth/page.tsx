    ...
    <main>
      <style>{`
        *{box-sizing:border-box}body{margin:0;background:#efe5d1;color:#2a211a}a{color:inherit}
        ...
        .music{display:grid;grid-template-columns:.7fr 1.3fr;gap:28px;align-items:center;background:#2d241d;color:#f8ecd8;padding:30px}.cover{width:100%;border:8px solid #efe1c8;display:block}.music h3{font-size:34px;margin:0 0 12px}.music p{color:#ddcdb6;line-height:1.8}.music a{color:#fff1d2}
        ...
        @media(max-width:760px){.shell{padding:0 16px}.nav{height:68px}.brand{font-size:20px}.hero{grid-template-columns:1fr;padding:42px 0 48px;gap:28px}.hero h1{font-size:58px}.copy{font-size:16px}.grid,.music,.contact{grid-template-columns:1fr}section{padding:46px 0}.heroArt{border-width:7px}.music{padding:22px}h2{font-size:41px}.letter{padding:26px 22px}}
      `}</style>
