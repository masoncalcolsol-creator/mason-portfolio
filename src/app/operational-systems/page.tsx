      ...
      <div className={styles.shell}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroCopy}>
            ...
            <div className={styles.heroActions}>
              <a href="#receipts" className={styles.primaryButton}>
                See operational receipts <ArrowRight size={17} />
              </a>
              <a href="#fit" className={styles.secondaryButton}>
                Where could this fit? <CircuitBoard size={17} />
              </a>
            </div>
          </div>
        ...
        <section id="fit" className={styles.fitSection}>
          <div className={styles.fitCopy}>
            ...
            <h2>I am not searching for a clever title.</h2>
            <p>
              I am searching for the place where hands-on operational experience, systems thinking, continuous improvement, and emerging AI capability can create measurable value together.
            </p>
          ...
          <aside className={styles.questionCard}>
            <ShieldCheck size={30} />
            <p>One question</p>
            <h2>Where does an operational systems builder best plug into your organization?</h2>
        ...
        <footer className={styles.footer}>
          ...
          <a href="/">Return to the full operating map</a>
        </footer>
      </div>
    </main>
  );
