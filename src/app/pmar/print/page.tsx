    ...
    <main className="pmars-print-page min-h-screen bg-slate-950 p-5 text-white">
      <div className="mx-auto max-w-md">
        <section className="screen-only mb-5">
          ...
          <p className="mt-2 text-sm text-slate-400">Brother 1.1 in x 3.5 in label. One marker, one page, one cut.</p>
        </section>
        ...
        <p className="screen-only mt-5 text-center text-xs text-slate-500">Brother media: 1.1 in x 3.5 in. Scale 100%. Print all should now mean exactly one page.</p>
      </div>
