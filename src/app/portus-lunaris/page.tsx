...
export default function PortusLunarisPage(){
  return <main className={styles.page}><div className={styles.shell}>
    ...
    <section className={styles.section} id="site"><div className={styles.sectionHeader}><div className={styles.kicker}>Working site candidate</div><h2 className={styles.h2}>Mare Tranquillitatis Pit.</h2><p className={styles.body}>PORT-T currently centers engineering research on the Mare Tranquillitatis Pit region at approximately 8.3355°N, 33.222°E.</p></div><div style={{border:'1px solid #293638',borderRadius:20,overflow:'hidden',background:'#0b1618',marginBottom:18}}><img src="/portus-lunaris/mtp-pit.svg" alt="Mare Tranquillitatis Pit, LROC NAC view" style={{display:'block',width:'100%',height:'auto'}}/><div style={{padding:'16px 20px',color:'#9eaca7',fontSize:13,lineHeight:1.6}}>Mare Tranquillitatis Pit · LROC NAC view recovered from the PORT-T visual evidence capture. This image shows the observed pit geometry; it does not prove the size or suitability of any connected subsurface cavern.</div></div><div className={styles.two}><div className={styles.panel}><h3>What we know now</h3><p>The pit is a confirmed lunar skylight/collapse feature with a large opening, steep walls, overhang/recess geometry and visible interior floor sectors. It is already worth serious reconnaissance.</p><p>What we do not yet know is just as important: full subsurface geometry, roof thickness, continuity, structural competence, access difficulty and best long-term use.</p></div><div className={styles.panel}><div className={styles.kicker}>Preservation law</div><h3>Map first. Build second.</h3><p><strong>Nothing irreversible goes down the throat until ARGUS has mapped the throat.</strong></p><p>ARGUS goes in to answer the question before UMBRA-governed port operations assign the answer. If the volume is best for people, protect it. If it is best for equipment, use it. If it is unsafe or low-value, build outward and keep the port moving.</p></div></div></section>
