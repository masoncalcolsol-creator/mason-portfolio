...
Subject: Eye of Kilrogg on the fireground
...
Eye of Kilrogg was built as a governed field companion: glasses as the sensing seam, a quiet HALO interface, Umbra as the permission layer, Hive as durable memory. This rebuild applies that same architecture to interior structure fire — before entry, during entry, and after a drone is knocked out of the air.
...
| --- | --- | --- |
| Eye of Kilrogg | sensing companion | scout + helmet eyes |
